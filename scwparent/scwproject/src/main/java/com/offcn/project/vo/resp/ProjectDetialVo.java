...
public class ProjectDetialVo {
    ...
    private List<TProjectImages> detailImagesList;
    ...
    public List<TProjectImages> getDetailImagesList() {
        return detailImagesList;
    }

    public void setDetailImagesList(List<TProjectImages> detailImagesList) {
